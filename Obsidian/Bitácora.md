...
- [[Bitácora/2026-09-12]] — Graphify no tiene plugin oficial de Claude Code: es el paquete `graphifyy` + skill; vendorizada en `.claude/skills/graphify/`, y `graphify claude install` aplicado con los hooks `PreToolUse` reescritos para no depender de una ruta absoluta.
