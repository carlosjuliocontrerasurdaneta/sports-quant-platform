...
- [ ] 2026-08-04 — **54 filas servidas pendientes fuera de la ventana de scores** (chile 42, tennis_atp_canadian_open 12; health check WARN). Misma clase que M-01 (cerrado el 08-02): instancias nuevas acumuladas, así que el fallback desde `data/historical/` no las cubre — verificar si es falta de backfill o ausencia de vendor para esas ligas. Decisión del operador: backfill (gratis) + settle (consume cuota API). Ver [[Bitácora/2026-08-04]].
