...
- [ ] Analizar `data/bets/intraday_edge_log.csv` cuando haya 2–4 semanas de datos (post 07-28 aprox.): comparar CLV de picks 11:00 vs hipotéticos intradía nuevos (`would_generate` sin `is_candidate`) vs confirmaciones. Si los intradía nuevos NO superan a los de las 11:00, la fase ofensiva de la #4 se rechaza. Ver [[Bitácora/2026-07-14]].
