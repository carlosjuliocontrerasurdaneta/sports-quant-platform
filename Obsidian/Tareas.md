...
- [ ] **Liquidar las 87 filas servidas pendientes fuera de la ventana de scores** (health check 2026-08-02: brasileirao 73, mlb 12, tenis 2 — no se liquidarán desde el feed diario): `python scripts/backfill_results.py --leagues brasileirao mlb --days 15` (ESPN/statsapi, gratis) y re-correr `SETTLE_ALL.bat` (consume cuota del API — decisión del operador). Ver [[Bitácora/2026-08-02]].
