...
- [ ] 2026-08-05 — **CLV de −48.5% y −28.0% en `tennis_wta_washington_open`** (grupo picks 11:00 del gate intradía). Un CLV de esa magnitud no es una apuesta mala: es un desajuste de precio o de línea. Distorsiona la media del grupo de comparación —quitando solo la peor fila, la ventaja intradía cae a la mitad— así que contamina el gate. Investigar el emparejamiento entrada↔cierre de esas filas. Relacionado con el hallazgo de cuotas `price_decimal = 1.0` del 07-24. Ver [[Bitácora/2026-08-04]].
