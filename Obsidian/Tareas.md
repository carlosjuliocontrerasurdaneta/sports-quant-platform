...
- [ ] #4 fase ofensiva: el gate ya es repetible (`scripts/intraday_gate_analysis.py`, criterios exactos en `sqp/audit/intraday_gate.py`). Primera lectura 2026-08-02: **INSUFICIENTE** (n=22 < 30) pero direccionalmente a favor — CLV intradía media +0.29% / beat 41% vs picks 11:00 −2.08% / 31%; el positivo lo carga el tenis (ATP +3.4%, n=4), MLB plano. Re-ejecutar el script cuando n_intradía ≥ 30 (~2ª semana de agosto); PASS exige mediana intradía > 0 Y > mediana 11:00. Ver [[Bitácora/2026-08-02]].
