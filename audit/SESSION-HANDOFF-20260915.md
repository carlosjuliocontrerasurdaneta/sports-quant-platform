...
Nota posterior: a petición del operador, el código y las pruebas se recuperaron
en la rama separada `codex/feature-signal-shadow` para versionarlos. Lo siguiente
describe el estado local previo a ese commit; los artefactos de datos/modelos
siguen siendo locales y no forman parte del repositorio remoto.
