...
| AUD-004 | MEDIUM | P2 | **mitigado** (padre renombrado; ruta canónica operativa) | — | `pytest --basetemp=.codex-tmp/pytest …` 4 passed; borrado del residuo denegado sin elevación | operador: eliminar `.codex-tmp/pytest.bloqueado-20260916/openai-20260916-retry` con privilegios |
