...
| AUD-005 | MEDIUM | P2 | corregido (variante «aviso»), pendiente de verificación (`4f06b4f`) | verificado-mitigado | 21 tests de line shopping/config; candado `test_execution_prices_sigue_sin_llamadores_en_el_pipeline` | decisión del operador sobre cablear el line shopping (clase de escalado); riesgo residual explícito y aceptado, sin cambios de código pendientes |
