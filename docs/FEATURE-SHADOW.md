...
El script integrado `scripts/feature_shadow.py`
...
del experimento. El 2026-09-16 se integraron y validaron los módulos y scripts en
el árbol principal. El experimento vigente mantiene su código congelado original;
la integración no sustituye sus modelos ni reinterpreta sus capturas. La primera
versión `feature_shadow_20260915` queda como referencia
...
El siguiente es el comando histórico de preparación del experimento vigente,
no un comando para repetir: su inicio ya ocurrió y su carpeta está reservada.
Para nuevos experimentos usar `python -B scripts/feature_shadow.py train --help`,
un informe y selección correspondientes, otra carpeta y una ventana futura.
...
La ventana prospectiva está abierta y termina el 2027-09-16. No se calculan
métricas anticipadas ni se puede garantizar captura continua durante apagados o
fallos del proveedor. La integración y comprobación de integridad del 2026-09-16
están documentadas en [el informe de integración](../audit/feature_integration_20260916.md).
